	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('input', { aaa: '', ref: 'newMessage', type: 'text', value: this.state.newMessage, onChange: this.updateNewMessage })
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventEmitter = __webpack_require__(163).EventEmitter2 || __webpack_require__(163);
	var safeDeepClone = __webpack_require__(164);
	var RenderMixin = __webpack_require__(165);
